...
\begin{document}
	...
	Several widgets were used to increase readability and brevity of code. For example, 'ReturnText()' allows for easy access to the main textual components used and improves readability. 
