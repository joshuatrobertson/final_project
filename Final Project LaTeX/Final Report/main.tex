...
\begin{document}
	...
	\end{lstlisting}
	For the search results we use a drop down menu in the form of flutters built in 'showSearch' function to display a search page and 'SearchDelegate' to define the content of said search page.
