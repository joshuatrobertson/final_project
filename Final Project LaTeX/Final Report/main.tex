...
\begin{document}
	...
	The COVID-19 pandemic has impacted virtually all areas of our life, from work, to travel, to how we socialise. Some of these changes are temporary, such as mask wearing, but others, such as the adoption of more digital services and flexible homeworking seem likely to be more permanent (ADD CITE). 
	The restriction of movement has caused consumers to migrate to online services at an unprecedented rate and with the global home services market expected to grow by almost 20\% per year until 2026 \cite{owen-ray} there exists a wealth of opportunity for companies to capitalise through digitalising previously physical services. One of these is hairdressing, which saw a sizeable uptake in demand throughout the pandemic. 
	\\
	...
	\begin{figure}[H]
		\centering
 		\includegraphics[scale=0.85]{images/minimal-prototype.png}
		\caption{ChopChop Minimal Design Prototype}
	...
	When designing the architecture, core business logic was kept separate from the UI, database and network. For example, when interacting with the database the UI called upon the utilities package and any API calls where contained within the providers package.
	...
	\end{figure}
	(TODO: REMOVE WATERMARK and discuss why modelled as a relational database)
	...
	\subsection{Widgets and Common Items and Added Features}
